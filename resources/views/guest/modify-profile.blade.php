    ...
    <main class="main" id="top">
        <div class="container-fluid px-0">
            ...
            <div class="content">
                ...
                <form  method="POST" action="/guest/modifier">
                    @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" id="exampleFormControlInput1" type="email" value="{{Auth::user()->email}}" name="email" placeholder="Votre nouveau email" readonly>
                  </div>
                  <div class="mb-0">
                  ...
                  <div class="mb-0">
                    <label class="form-label" for="exampleTextarea">Mot de passe</label>
                    <input type="password" class="form-control" id="exampleTextarea" rows="3" name="password" placeholder="Mot de passe">
                  </div>
