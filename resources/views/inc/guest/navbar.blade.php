<nav class="navbar navbar-light navbar-top navbar-expand">
    <div class="navbar-logo"><button class="btn navbar-toggler navbar-toggler-humburger-icon" type="button"
            ...
            <div class="d-flex align-items-center">
                <div class="d-flex align-items-center">
                    <p class="logo-text ms-1 d-none d-sm-block">MOM</p>
                </div>
            </div>
        </a></div>
    <div class="collapse navbar-collapse">
        ...
        <ul class="navbar-nav navbar-nav-icons ms-auto flex-row">
                    ...
                    <div class="card bg-white position-relative border-0">
                        <div class="card-body pt-3 px-3 pb-0 overflow-auto scrollbar" style="height: 20rem;">
                            <div class="row text-center align-items-center gx-0 gy-0">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img src="assets/img/nav-icons/linkedin.png"
                                            alt="" width="30">
            ...
            <li class="nav-item dropdown"><a class="nav-link lh-1 px-0 me-3" id="navbarDropdownUser" href="#"
                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="avatar avatar-l"><img class="rounded-circle"
                            src="{{ asset('dashassets/img/team/57.png') }}" alt=""></div>
                </a>
                <div class="me-4 dropdown-menu dropdown-menu-end py-0 dropdown-profile shadow border border-300"
                    ...
                    <div class="card bg-white position-relative border-0 ">
                        <div class="card-body p-0 overflow-auto scrollbar" style="height: 18rem;">
                            ...
                            <ul class="nav d-flex flex-column mb-2 pb-1">
                                <li class="nav-item"><a class="nav-link px-3" href="/modifyProfile"><span
                                            class="me-2 text-900" data-feather="user"></span>Profile</a>
                                </li>
                                <li class="nav-item"><a class="nav-link px-3" href="/client/dashboard"><span
                        ...
                        <div class="card-footer p-0 border-top">
                            ...
                            <div class="px-3"><a class="btn btn-phoenix-secondary d-flex flex-center w-100"
                                ...
                                document.getElementById('logout-form').submit();"
                                    href="!#"><span class="me-2" data-feather="log-out"></span>Sign out
